...
from mmdetection.mmdet.models.utils.custom_checkpoint import load_checkpoint
...
class ResNet(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        if isinstance(pretrained, str):
            ...
            load_checkpoint(self, pretrained, strict=False, logger=logger, load_type='backbone')
