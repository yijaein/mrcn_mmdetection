...
# checkpoint_path = '/home/bong3/lib/robin_mrcnn/work_dirs/190519_epoch_12.pth'
checkpoint_path = "/home/bong3/lib/robin_mrcnn/work_dirs/cascade_rcnn_dconv_c3-c5_r50_fpn_1x_iitp_1920_with_coco_vis/latest.pth"
...
# img_dir_path = "/home/bong3/data/iitp/track1/drone_sample/t1_video_00061"
# one_dir_checked = True
...
result_info_save_path = "/home/bong3/data/iitp/track1/pkl/result_info_epoch_12_sample.pkl"
                ...
                if label in [0,1,2,4]:
                        ...
                        for object_index, before_object in enumerate(more_before_label_objects):
                            ...
                            if dist_frame != 1:
                                for num in range(1, dist_frame + 1):
                                    limit_coord_dist += (limit_coord_dist * np.exp(-num)*2) #np.exp2(-num))
                            ...
                            if (dist_frame < 2 and pred_coord_dist < dist_px) or pred_coord_dist < limit_coord_dist:
                    ...
                    for before_frame_index in range(max(i - 100, 0), i):
                        ...
                        for object_index, before_object in enumerate(more_before_label_objects):
                            ...
                            if dist_frame != 1:
                                for num in range(1, dist_frame + 1):
                                    limit_coord_dist += (limit_coord_dist * np.exp2(-num))
