...
from facebook_mrcnn.maskrcnn_benchmark.utils.comm import get_rank
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="../../configs/kidney/e2e_mask_rcnn_X_101_32x8d_FPN_1x_liver_kidney_augpolygon_using_pretrained_model.yaml",
        metavar="FILE",
