...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/home/bong3/lib/robin_mrcnn/facebook_mrcnn/configs/example/caffe2/e2e_mask_rcnn_X-152-32x8d-FPN-IN5k_1.44x_caffe2.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        ...
        default=None, #'MODEL.WEIGHT "/home/bong07/lib/robin_mrcnn/checkpoint/20190117-141315/model_0005000.pth"',
