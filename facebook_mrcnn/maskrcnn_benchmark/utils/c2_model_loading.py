...
_C2_STAGE_NAMES = {
    ...
    "SE-50": ["1.2", "2.3", "3.5", "4.2"],
    "SE-101": ["1.2", "2.3", "3.22", "4.2"],
    "SE-152": ["1.2", "2.7", "3.35", "4.2"],
}
...
@C2_FORMAT_LOADER.register("SE-50-C4")
@C2_FORMAT_LOADER.register("SE-50-C5")
@C2_FORMAT_LOADER.register("SE-101-C4")
@C2_FORMAT_LOADER.register("SE-101-C5")
@C2_FORMAT_LOADER.register("SE-50-FPN")
@C2_FORMAT_LOADER.register("SE-101-FPN")
@C2_FORMAT_LOADER.register("SE-152-FPN")
