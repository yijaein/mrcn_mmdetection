...
from facebook_mrcnn.maskrcnn_benchmark.layers import SigmoidFocalLoss
...
from facebook_mrcnn.maskrcnn_benchmark.modeling.rpn.loss import RPNLossComputation
